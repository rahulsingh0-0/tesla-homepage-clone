      ...
      <div className="header">
        ...
        <div className="main_links">
          <nav>
            <ul>
              <li>
                <a className="model-link" href="https://www.tesla.com/">
                  Model S
                </a>
              </li>
              <li>
                <NavLink className="model-link" to="/">
                  Model 3
                </NavLink>
              </li>
              <li>
        ...
        <div className="actions head">
          <ul>
            ...
            <li>
              <NavLink onClick={props.show} className="model-link" to="/">
                Menu
              </NavLink>
            </li>
          </ul>
        ...
        <div className="action-mobile">
          <NavLink onClick={props.show} className="model-link mobile" to="/">
            Menu
          </NavLink>
        </div>
      </div>
